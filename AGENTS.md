...
You must ALWAYS ensure that `cargo test` passes cleanly before committing changes or closing tickets.
...
## Rules
 ...
 - NEVER create temporary files in the root. ONLY EVER create them in the `tmp/` directory. ALWAYS clean them up after you're finished using them.
