...
c_tests = open("fidlc/tests/recoverable_compilation_tests.cc").read()
...
blocks = c_tests.split("TEST(RecoverableCompilationTests, ")
...
with open("src/tests/recoverable_compilation_tests.rs", "w") as f:
    f.write(rust_code)
